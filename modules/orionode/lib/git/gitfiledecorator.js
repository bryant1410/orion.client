...
Object.assign(GitFileDecorator.prototype, {
	decorate: function(req, file, json) {
		...
		var endpoint = req.originalUrl.split("/")[1];//TODO context path
		...
		if (isWorkspace && req.method === "GET") {
			...
			return Promise.all(children.map(function(child) {
				return addWorkSpaceGitLinks(gitRoot, child, {workspaceDir: file.workspaceDir, path: api.join(file.workspaceDir,child.Name)});		
			}));
		}
		if (!isWorkspace && req.method === "GET") {
